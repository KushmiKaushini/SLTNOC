...
import 'elements_location3.dart';
import 'error_dialog.dart';
import 'package:sltnoc/app_config.dart';
import 'package:sltnoc/loading_indicator.dart';

class ElementsLocationPage2 extends StatefulWidget {
  final String name; // Add the 'name' parameter

  const ElementsLocationPage2({Key? key, required this.name}) : super(key: key);

  @override
  _ElementsLocationPage2State createState() => _ElementsLocationPage2State();
}

class _ElementsLocationPage2State extends State<ElementsLocationPage2> {
                    ...
                    if (selected != null && selected) {
                      if (count['Geo Locations'] == '***') {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ElementsLocationPage3(
                                name: widget.name,
                                elementName: count['Element Name']),
                          ),
                        );
