...
import 'elements_location2.dart';
import 'package:sltnoc/app_config.dart';
import 'package:sltnoc/loading_indicator.dart';

class ElementsLocationPage extends StatefulWidget {
  const ElementsLocationPage({Key? key}) : super(key: key);

  @override
  _ElementsLocationPageState createState() => _ElementsLocationPageState();
}

class _ElementsLocationPageState extends State<ElementsLocationPage> {
                ...
                return DataRow(
                  onSelectChanged: (bool? selected) {
                    if (selected != null && selected) {
                      // Navigate to ElementsLocationPage2 when the row is tapped
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) =>
                              ElementsLocationPage2(name: count['Name']),
                        ),
                      );
                    }
                  },
