...
import 'elementsMap2.dart';
import 'package:sltnoc/app_config.dart';
import 'package:sltnoc/loading_indicator.dart';

class elementsMapPage extends StatefulWidget {
  const elementsMapPage({Key? key}) : super(key: key);

  @override
  _elementsMapPageState createState() => _elementsMapPageState();
}

class _elementsMapPageState extends State<elementsMapPage> {
                  ...
                  onSelectChanged: (bool? selected) {
                    if (selected != null && selected) {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              elementsMapPage2(name: count['Name']),
                        ),
                      );
                    }
                  },
