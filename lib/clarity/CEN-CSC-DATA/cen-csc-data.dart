...
class cenCscDataPage extends StatefulWidget {
  final String title;

  const cenCscDataPage({
    Key? key,
    required this.title,
  }) : super(key: key);

  @override
  _cenCscDataPageState createState() => _cenCscDataPageState();
}

class _cenCscDataPageState extends State<cenCscDataPage> {
  late Future<void> _fetchDataFuture;
  List<Map<String, dynamic>> cen_csc_data = [];
                        ...
                        padding: EdgeInsets.symmetric(
                            vertical: 0.04 *
                                (MediaQuery.of(context).orientation ==
                                        Orientation.portrait
                                    ? screenWidth
                                    : screenHeight)), // Add top and bottom margin
                        child: Container(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: [
                                ...
                                const WidgetSpan(
                                    child: SizedBox(
                                        height: AppConfig.SizedBoxHeight2)),
                                TextSpan(
                                    text: index['Status'],
                                    style: TextStyle(
                                        fontSize: 0.034 *
