...
class cenCscCCPage extends StatefulWidget {
  final String title;
  ...
  @override
  _cenCscCCPageState createState() => _cenCscCCPageState();
}

class _cenCscCCPageState extends State<cenCscCCPage> {
