...
class cenCscNwPage extends StatefulWidget {
  final String title;
  ...
  @override
  _cenCscNwPageState createState() => _cenCscNwPageState();
}

class _cenCscNwPageState extends State<cenCscNwPage> {
  late Future<void> _fetchDataFuture;
  List<Map<String, dynamic>> cen_csc_nw = [];
                    ...
                    DataCell(
                      Padding(
                        ...
                        child: Container(
                          ...
                          // height: 130, // Increase the height to accommodate the description
                          child: RichText(
                            text: TextSpan(
                              children: [
                                TextSpan(
